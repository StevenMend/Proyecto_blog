...
def send_email(name, email, phone, message):
    ...
    email_message['From'] = os.getenv('OWN_EMAIL')
    email_message['To'] = os.getenv('OWN_EMAIL')
    ...
    try:
        with smtplib.SMTP("smtp.gmail.com", 587) as connection:
            ...
            connection.sendmail(os.getenv('OWN_EMAIL'), os.getenv('OWN_EMAIL'), email_message.as_string())
    except Exception as e:
        print(f"Error sending email: {e}")
        raise
